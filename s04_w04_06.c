...
/*1.ค่าคงที่ GLOBAL_RATE และ LOCAL_BONUS ต่างกันอย่างไร?
  - GLOBAL_RATE เป็นค่าคงที่ระดับ global ใช้งานได้จากทุกฟังก์ชั่นในโปแกรม
  - LOCAL_BONUS เป็นค่าคงที่ระดับ local ใช้ได้ในเฉพาะฟังก์ชั่น calculate()
  ...
  3.ทำไม LOCALBONUS ถึงไม่สามารถเรียกใช้ใน main() ได้?
  -เพราะ LOCAL_BONUS ถูกประกาศเป็น local ในฟังก์ชั่น calculate() และมี scope อยู่แต่ในฟังก์ชั่น
